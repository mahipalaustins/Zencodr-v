...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#0a0e1a] relative overflow-hidden">
            {/* Background Elements */}
            <div className="absolute top-[-20%] right-[-10%] w-[50%] h-[50%] bg-[#00d4ff]/10 rounded-full blur-[100px] animate-pulse"></div>
            <div className="absolute bottom-[-20%] left-[-10%] w-[50%] h-[50%] bg-[#ff00ff]/10 rounded-full blur-[100px] animate-pulse delay-1000"></div>
            ...
            <div className="w-full max-w-md p-8 rounded-2xl bg-[#121929]/70 border border-white/10 backdrop-blur-md shadow-2xl relative z-10 animate-[fadeIn_0.5s]">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-[#00d4ff] to-[#ff00ff] bg-clip-text text-transparent mb-2">Create Account</h1>
                ...
                <div className="mt-6 text-center text-gray-400 text-sm">
                    ...
                    <Link href="/login" className="text-[#00d4ff] hover:text-[#ff00ff] transition-colors font-medium">
                        Sign in
                    </Link>
                </div>
            </div>
