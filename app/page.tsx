...
export default function LandingPage() {
    ...
    return (
        ...
        `}</style>
            ...
            {/* Header */}
            <header className="fixed top-0 w-full bg-white/5 backdrop-blur-md border-b border-white/10 px-8 py-4 z-[100] flex justify-between items-center animate-[slideDown_0.5s_ease-out]">
                ...
                <nav className="hidden md:flex gap-6">
                    <Link href="/" className="text-[#00d4ff] relative after:content-[''] after:absolute after:bottom-[-20px] after:left-0 after:w-full after:h-[2px] after:bg-[#00d4ff] after:shadow-[0_0_10px_#00d4ff] hover:text-white transition-colors">
                        Home
                    </Link>
